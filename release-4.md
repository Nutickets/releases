Nuweb Systems Platform Release 4: March 26th - April 20th 2021
...
- Reserved Seating:
  ...
  - Seat accessibility: display accessibility icon over seat, you can choose to highlight it with a blue background colour too. Accessibility icon was added into the icon library too.
...
- Added a new importer to allow migration of customers from external systems
